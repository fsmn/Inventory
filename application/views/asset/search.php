...
<form name="asset-search" class="form-dialog" id="asset-search" method="get" action="<?php echo site_url("asset/search");?>">
	...
	<div class="type-status">
		...
		<div class="column no-wrap">
			...
			<input type="text" class="form-control year" id="year_acquired" name="year_acquired" value="<?php $this->input->get("year_acquired");?>"
				size="5"
			/>
			&nbsp;-&nbsp;
		...
		<div id="year_removed_block" class="column no-wrap">
			...
			<input type="text" class="form-control year" id="year_removed" name="year_removed" value="<?php echo $this->input->get("year_removed");?>"
				size="5"
			/>
			&nbsp;-&nbsp;
