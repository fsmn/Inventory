...
<form id="asset_editor" class="editor" name="asset_editor"
	...
	<input type="hidden" name="id" id="id"
		value="<?=get_value($asset, 'id')?>" />
	<input type="hidden" name="action" id="action" value="<?=$action?>" />
	<p>
		<label for="vendor_id">Developer&nbsp;</label> <span id='vendor_list'> <?=form_dropdown('vendor_id', $developers, get_value($asset, 'vendor_id',$vendor_id), 'id="vendor_id"')?>
		</span>
	</p>
	<p>
		<label for="product">Product Name&nbsp;</label>
		<input type="text" id="product" name="product" required
			value="<?=get_value($asset, 'product');?>" />
	</p>
	<p>
		<label for="name">Asset Name</label>
		<input type="text" id="name" name="name"
			value="<?=get_value($asset, 'name');?>" />
	</p>

	<p>
		<label for="version">Version&nbsp;</label>
		<input type="text" id="version" name="version"
			value="<?=get_value($asset, 'version');?>" />
	</p>
	...
	<div id="year_removed_block"
		...
		<label for="year_removed">Year Removed</label>
		<input type="text" id="year_removed" name="year_removed"
	...
	<p>
		...
		<input type="submit"
			class="save_order <?=$action;?> <?=implode(" ",get_button_style($action));?>"
