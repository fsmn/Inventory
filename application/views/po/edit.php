<?php
?>
<form id="order-editor" class="form-dialog form-horizontal" action="<?php echo site_url("po/$action"); ?>" method="post" name="order-editor">
	<input type="hidden" name="id" value="<?php echo get_value($po,"id");?>" />
	...
	<div class="form-group">
		...
		<div class="col-sm-8" id="vendor-view"><?php echo form_dropdown ( 'vendor_id', $vendors, get_value ( $po, 'vendor_id', $vendor_id ), 'id="vendor_id" class="form-control"' );?></div>
	</div>
...
<div class="form-group">
		...
		<div class="col-sm-8">
			e-
			<input type="text" class="form-control" name="po" id="po" readonly style="width: 4em" value="<?php echo get_value($po, 'po'); ?>" />
			<span id="valid-po">&nbsp;</span>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-8">
			e-
			<input type="text" class="form-control" name="new-po" id="new-po" style="width: 4em" value="<?php echo get_value($po, 'po'); ?>" />
...
<div class="form-group">
		...
		<div class="col-sm-8">
			e-
			<input type="text" class="form-control" name="po" id="po" style="width: 5em" value="<?php echo get_value($po, 'po'); ?>" />
...
<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="date" class="form-control" name="po_date" id="po_date" style="width: auto;"
				value="<?php echo get_value($po, 'po_date',date("Y-m-d"));?>"
			/>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="billing_contact" id="billing_contact" readonly style="width: auto;"
				value="<?php echo get_value($po, 'billing_contact', BILLING_CONTACT); ?>"
			/>
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-4 control-label no-wrap" for="category">Order Category: </label>
		<div class="col-sm-8" id="category-view"> <?php echo form_dropdown ( 'category', $categories, urlencode ( get_value ( $po, 'category' ) ), 'id="category" class="form-control"' );?> </div>
	</div>
	<div class="form-group">
		<label class="col-sm-4 control-label no-wrap" for="quote">Vendor Quote Number: </label>
		<div class="col-sm-8">
			<input type="text" class="form-control" name="quote" id="quote" style="width: auto;" value="<?php echo get_value($po, 'quote')?>" />
		</div>
	</div>
	<div class="form-group">
		<div class="col-sm-offset-4 col-sm-8">
			<input type="submit" class="form-control save_order <?php echo $action;?> <?php echo implode(" ",get_button_style($action));?>"
