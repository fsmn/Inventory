...
if ($order->approved && !$order->complete) {
    $order_buttons [] = array(
        'text' => 'Modify',
        'style' => 'edit',
                ...
                <fieldset>
                    ...
                    <div id="order-info">
                        <ul class="unformatted">
                            <li><label for="approved">Is
                                    Approved:&nbsp;</label><?php echo $order->approved ? "Yes" : "No"; ?></li>
                            ...
                            <li><label for="orderer_id">Ordered
                                    By:&nbsp;</label><?php echo $order->first_name . " " . $order->last_name; ?>
                            </li>
                            <li><label for="billing_contact">Billing
                                    Contact:&nbsp;</label><?php echo $order->billing_contact; ?>
                            </li>
...
<?php if ($assets): ?>
    <a href="<?php echo site_url("asset/po_list/$order->po"); ?>" title="View ordered assets in service">View the above
        assets in service</a>
