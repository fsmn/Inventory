...
The purchase may not yet have been made, but <?php printf("%s %s",$po->first_name, $po->last_name); ?>  submitted purchase order <?php echo $po->po; ?> to <?php echo $po->approver; ?> for approval. 
